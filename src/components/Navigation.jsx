    ...
    return (
      <nav className="side-nav">
        <div>
          <div
            className={`side-nav-item  ${
              this.props.location === '/' ? 'side-nav-item-active' : ''
            }`}
          ...
          <div
            className={`side-nav-item  ${
              this.props.location === 'call' ? 'side-nav-item-active' : ''
            }`}
        ...
        <div>
          <div
            className={`side-nav-item ${
              this.props.location === 'admin-page' ? 'side-nav-item-active' : ''
            }`}
          ...
          <div
            ...
            <div
              ...
              style={{
                display: this.state.isDropdownShowing ? 'block' : 'none',
              }}>
              <div className="dropdown-item m-0 pr-2 pl-5 ">
                <input
                  ...
                  checked={this.state.isDarkThemeActive}></input>
                Tamna tema
              </div>
            </div>
          </div>
